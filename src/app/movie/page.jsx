...
export default function page() {
  return (
    <main id='top' className='relative z-0'>
       <h2 className='absolute top-0 left-20 md:left-32 text-4xl md:text-7xl 3xl:text-9xl text-white opacity-30 z-1'>M O V I E</h2>
       <h2 className='absolute top-2 left-24 md:left-36 text-4xl md:text-7xl 3xl:text-9xl text-teal-800 opacity-30 z-10 hover:opacity-50'>M O V I E</h2>
    <section id="action" className='z-50 bg-slate-900 flex justify-center items-center'>
      <div className='mt-8 ml-2 md:ml-32 w-[90%] h-[90%] flex flex-col gap-4 '>
        <div className='z-50 h-[5%] w-full flex justify-center items-center gap-2'>
           <a href='#action' className='h-full w-[70px] lg:w-[150px]'><div className='h-full w-[70px] lg:w-[150px] text-sm md:text-lg flex justify-center items-center rounded-full bg-cyan-300'>ACTION</div></a>
           <a href='#fantastique' className='h-full w-[70px] lg:w-[150px]'><div className='h-full w-[70px] lg:w-[150px] text-sm md:text-lg flex justify-center items-center rounded-full bg-cyan-300'>FANTASY</div></a>
           <a href='#emotion' className='h-full w-[70px] lg:w-[150px]'><div className='h-full w-[70px] lg:w-[150px] text-sm md:text-lg flex justify-center items-center rounded-full bg-cyan-300'>EMOTION</div></a>
           <a href='#frisson' className='h-full w-[70px] lg:w-[150px]'><div className='h-full w-[70px] lg:w-[150px] text-sm md:text-lg flex justify-center items-center rounded-full bg-cyan-300'>HORROR</div></a>
           <a href='#famille' className='h-full w-[70px] lg:w-[150px]'><div className='h-full w-[70px] lg:w-[150px] text-sm md:text-lg flex justify-center items-center rounded-full bg-cyan-300'>FAMILY</div></a>
        </div>
